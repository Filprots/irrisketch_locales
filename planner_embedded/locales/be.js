(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Лінія", "Лінія маляванне", "Лінія рэдагаванне"],
            spLine: ["Лінія", "Лінія маляванне", "Лінія рэдагаванне"],
            loLine: ["Лінія", "Лінія маляванне", "Лінія рэдагаванне"],
            ldLineWithArea: ["Лінія (m2)", "Лінія (m2) маляванне", "Лінія (m2) рэдагаванне"],
            spLineWithArea: ["Лінія (m2)", "Лінія (m2) маляванне", "Лінія (m2) рэдагаванне"],
            loLineWithArea: ["Лінія (m2)", "Лінія (m2) маляванне", "Лінія (m2) рэдагаванне"],
            ldVolumetricLine: ["Лінія (m3)", "Лінія (m3) маляванне", "Лінія (m3) рэдагаванне"],
            spVolumetricLine: ["Лінія (m3)", "Лінія (m3) маляванне", "Лінія (m3) рэдагаванне"],
            loVolumetricLine: ["Лінія (m3)", "Лінія (m3) маляванне", "Лінія (m3) рэдагаванне"],
            polyLdSurface: ["Паверхня", "Маляванне паверхні", "Рэдагаванне паверхні"],
            polySpSurface: ["Паверхня", "Маляванне паверхні", "Рэдагаванне паверхні"],
            polyLoSurface: ["Паверхня", "Маляванне паверхні", "Рэдагаванне паверхні"],
            polyLdVolumetricSurface: ["Паверхня", "Маляванне паверхні (m3)", "Рэдагаванне паверхні (m3)"],
            polySpVolumetricSurface: ["Паверхня", "Маляванне паверхні (m3)", "Рэдагаванне паверхні (m3)"],
            polyLoVolumetricSurface: ["Паверхня", "Маляванне паверхні (m3)", "Рэдагаванне паверхні (m3)"],
            brushLdSurface: ["Паверхня", "Маляванне паверхні", "Рэдагаванне паверхні"],
            brushSpSurface: ["Паверхня", "Маляванне паверхні", "Рэдагаванне паверхні"],
            brushLoSurface: ["Паверхня", "Маляванне паверхні", "Рэдагаванне паверхні"],
            brushLdVolumetricSurface: ["Паверхня", "Маляванне паверхні (m3)", "Рэдагаванне паверхні (m3)"],
            brushSpVolumetricSurface: ["Паверхня", "Маляванне паверхні (m3)", "Рэдагаванне паверхні (m3)"],
            brushLoVolumetricSurface: ["Паверхня", "Маляванне паверхні (m3)", "Рэдагаванне паверхні (m3)"],
            ...
            dl16: ["Кропельная лінія 16/13mm", "Кладка кропельнай лініі 16/13mm", "Рэдагаванне кропельнай лініі 16/13mm"],
            ds16: ["Старт 16/13mm", "Маляванне кропельнага старту 16/13mm", "Рэдагаванне кропельнага старту 16/13mm"],
            ...
            proHE: ["PRO-HE Adjustable Nozzle", "Усталёўка фарсункі PRO-HE Adjustable", "Рэдагаванне фарсункі PRO-HE Adjustable"],
        ...
        vars: {
            ...
            obstacles: "Перашкоды для ірыгацыі",
            placementObstacles: "Перашкоды для размяшчэння",
            stdSurf: "Стандартная",
            ...
            wirelessControl: "Бесправадное кіраванне",
            sensorWire: "Праводка чуйніка",
            wirelessSensor: "Бесправаднае злучэнне сэнсараў",
