(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Line", "Line drawing", "Line editing"],
            spLine: ["Line", "Line drawing", "Line editing"],
            loLine: ["Line", "Line drawing", "Line editing"],
            ldLineWithArea: ["Line (m2)", "Line (m2) drawing", "Line (m2) editing"],
            spLineWithArea: ["Line (m2)", "Line (m2) drawing", "Line (m2) editing"],
            loLineWithArea: ["Line (m2)", "Line (m2) drawing", "Line (m2) editing"],
            ldVolumetricLine: ["Line (m3)", "Line (m3) drawing", "Line (m3) editing"],
            spVolumetricLine: ["Line (m3)", "Line (m3) drawing", "Line (m3) editing"],
            loVolumetricLine: ["Line (m3)", "Line (m3) drawing", "Line (m3) editing"],
            polyLdSurface: ["Surface", "Surface drawing", "Surface editing"],
            polySpSurface: ["Surface", "Surface drawing", "Surface editing"],
            polyLoSurface: ["Surface", "Surface drawing", "Surface editing"],
            polyLdVolumetricSurface: ["Surface", "Surface (m3) drawing", "Surface (m3) editing"],
            polySpVolumetricSurface: ["Surface", "Surface (m3) drawing", "Surface (m3) editing"],
            polyLoVolumetricSurface: ["Surface", "Surface (m3) drawing", "Surface (m3) editing"],
            brushLdSurface: ["Surface", "Surface drawing", "Surface editing"],
            brushSpSurface: ["Surface", "Surface drawing", "Surface editing"],
            brushLoSurface: ["Surface", "Surface drawing", "Surface editing"],
            brushLdVolumetricSurface: ["Surface", "Surface (m3) drawing", "Surface (m3) editing"],
            brushSpVolumetricSurface: ["Surface", "Surface (m3) drawing", "Surface (m3) editing"],
            brushLoVolumetricSurface: ["Surface", "Surface (m3) drawing", "Surface (m3) editing"],
            ...
            proHE: ["PRO High Efficiency Adjustable Nozzle", "PRO High Efficiency Adjustable Nozzle placing", "PRO High Efficiency Adjustable Nozzle editing"],
        ...
        vars: {
            ...
            obstacles: "Obstacles for irrigation",
            placementObstacles: "Obstacles for placement",
            stdSurf: "Standard",
            ...
            wirelessControl: "Wireless control",
            sensorWire: "Sensor wire",
            wirelessSensor: "Wireless sensor connection",
