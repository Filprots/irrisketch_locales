(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Ligne", "Dessin de ligne", "Édition de ligne"],
            spLine: ["Ligne", "Dessin de ligne", "Édition de ligne"],
            loLine: ["Ligne", "Dessin de ligne", "Édition de ligne"],
            ldLineWithArea: ["Ligne (m2)", "Dessin de ligne (m2)", "Édition de ligne (m2)"],
            spLineWithArea: ["Ligne (m2)", "Dessin de ligne (m2)", "Édition de ligne (m2)"],
            loLineWithArea: ["Ligne (m2)", "Dessin de ligne (m2)", "Édition de ligne (m2)"],
            ldVolumetricLine: ["Ligne (m3)", "Dessin de ligne (m3)", "Édition de ligne (m3)"],
            spVolumetricLine: ["Ligne (m3)", "Dessin de ligne (m3)", "Édition de ligne (m3)"],
            loVolumetricLine: ["Ligne (m3)", "Dessin de ligne (m3)", "Édition de ligne (m3)"],
            polyLdSurface: ["Surface", "Dessin de surface", "Édition de surface"],
            polySpSurface: ["Surface", "Dessin de surface", "Édition de surface"],
            polyLoSurface: ["Surface", "Dessin de surface", "Édition de surface"],
            polyLdVolumetricSurface: ["Surface", "Dessin de surface (m3)", "Édition de surface (m3)"],
            polySpVolumetricSurface: ["Surface", "Dessin de surface (m3)", "Édition de surface (m3)"],
            polyLoVolumetricSurface: ["Surface", "Dessin de surface (m3)", "Édition de surface (m3)"],
            brushLdSurface: ["Surface", "Dessin de surface", "Édition de surface"],
            brushSpSurface: ["Surface", "Dessin de surface", "Édition de surface"],
            brushLoSurface: ["Surface", "Dessin de surface", "Édition de surface"],
            brushLdVolumetricSurface: ["Surface", "Dessin de surface (m3)", "Édition de surface (m3)"],
            brushSpVolumetricSurface: ["Surface", "Dessin de surface (m3)", "Édition de surface (m3)"],
            brushLoVolumetricSurface: ["Surface", "Dessin de surface (m3)", "Édition de surface (m3)"],
            ...
            dl16: ["Goutte à goutte 16/13mm", "Dessin goutte à goutte 16/13mm", "Montage goutte à goutte 16/13mm"],
            ds16: ["Goutte à goutte 16/13mm", "Dessin goutte à goutte 16/13mm", "Montage goutte à goutte 16/13mm"],
        ...
        vars: {
            ...
            obstacles: "Obstacles pour l'irrigation",
            placementObstacles: "Obstacles pour le placement",
            stdSurf: "Standard",
            ...
            wirelessControl: "Contrôle sans fil",
            sensorWire: "Fil de capteur",
            wirelessSensor: "Connexion sans fil des capteurs",
            wirelessWire: "Connexion sans fil",
            dS16: "Goutte à goutte 16/13mm",
            ...
            "a0hor": "A0 Paysage",
            "a0vert": "A0 Portrait",
            "dind4hor": "DIN D4 Paysage",
            "dind4vert": "DIN D4 Portrait",
            "dind3hor": "DIN D3 Paysage",
            "dind3vert": "DIN D3 Portrait",
            "dind2hor": "DIN D2 Paysage",
            "dind2vert": "DIN D2 Portrait",
            "dind1hor": "DIN D1 Paysage",
            "dind1vert": "DIN D1 Portrait",
            "dind0hor": "DIN D0 Paysage",
            "dind0vert": "DIN D0 Portrait",
            "ansiAhor": "ANSI A Paysage",
            "ansiAvert": "ANSI A Portrait",
            "ansiBhor": "ANSI B Paysage",
            "ansiBvert": "ANSI B Portrait",
            "ansiChor": "ANSI C Paysage",
            "ansiCvert": "ANSI C Portrait",
            "ansiDhor": "ANSI D Paysage",
            "ansiDvert": "ANSI D Portrait",
            "ansiEhor": "ANSI E Paysage",
            "ansiEvert": "ANSI E Portrait",
            "archAhor": "Arch A Paysage",
            "archAvert": "Arch A Portrait",
            "archBhor": "Arch B Paysage",
            "archBvert": "Arch B Portrait",
            "archChor": "Arch C Paysage",
            "archCvert": "Arch C Portrait",
            "archDhor": "Arch D Paysage",
            "archDvert": "Arch D Portrait",
            "archEhor": "Arch E Paysage",
            "archEvert": "Arch E Portrait",
            "archE1hor": "Arch E1 Paysage",
            "archE1vert": "Arch E1 Portrait",
            "archE2hor": "Arch E2 Paysage",
            "archE2vert": "Arch E2 Portrait",
            "archE3hor": "Arch E3 Paysage",
            stdCompass: "Boussole",
            gostSize: "Taille",
