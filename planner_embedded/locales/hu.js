(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            polyLdSurface: ["Felület", "Felület rajzolása", "Felület szerkesztése"],
            polySpSurface: ["Felület", "Felület rajzolása", "Felület szerkesztése"],
            polyLoSurface: ["Felület", "Felület rajzolása", "Felület szerkesztése"],
            polyLdVolumetricSurface: ["Felület", "Felület (m3) rajzolása", "Felület (m3) szerkesztése"],
            polySpVolumetricSurface: ["Felület", "Felület (m3) rajzolása", "Felület (m3) szerkesztése"],
            polyLoVolumetricSurface: ["Felület", "Felület (m3) rajzolása", "Felület (m3) szerkesztése"],
            brushLdSurface: ["Felület", "Felület rajzolása", "Felület szerkesztése"],
            brushSpSurface: ["Felület", "Felület rajzolása", "Felület szerkesztése"],
            brushLoSurface: ["Felület", "Felület rajzolása", "Felület szerkesztése"],
            brushLdVolumetricSurface: ["Felület", "Felület (m3) rajzolása", "Felület (m3) szerkesztése"],
            brushSpVolumetricSurface: ["Felület", "Felület (m3) rajzolása", "Felület (m3) szerkesztése"],
            brushLoVolumetricSurface: ["Felület", "Felület (m3) rajzolása", "Felület (m3) szerkesztése"],
