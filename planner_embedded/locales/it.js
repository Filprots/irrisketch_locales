(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Linea", "Linea disegno", "Linea modifica"],
            spLine: ["Linea", "Linea disegno", "Linea modifica"],
            loLine: ["Linea", "Linea disegno", "Linea modifica"],
            ldLineWithArea: ["Linea (m2)", "Linea (m2) disegno", "Linea (m2) modifica"],
            spLineWithArea: ["Linea (m2)", "Linea (m2) disegno", "Linea (m2) modifica"],
            loLineWithArea: ["Linea (m2)", "Linea (m2) disegno", "Linea (m2) modifica"],
            ldVolumetricLine: ["Linea (m3)", "Linea (m3) disegno", "Linea (m3) modifica"],
            spVolumetricLine: ["Linea (m3)", "Linea (m3) disegno", "Linea (m3) modifica"],
            loVolumetricLine: ["Linea (m3)", "Linea (m3) disegno", "Linea (m3) modifica"],
            polyLdSurface: ["Superficie", "Disegno della superficie", "Modifica della superficie"],
            polySpSurface: ["Superficie", "Disegno della superficie", "Modifica della superficie"],
            polyLoSurface: ["Superficie", "Disegno della superficie", "Modifica della superficie"],
            polyLdVolumetricSurface: ["Superficie", "Disegno della superficie (m3)", "Modifica della superficie (m3)"],
            polySpVolumetricSurface: ["Superficie", "Disegno della superficie (m3)", "Modifica della superficie (m3)"],
            polyLoVolumetricSurface: ["Superficie", "Disegno della superficie (m3)", "Modifica della superficie (m3)"],
            brushLdSurface: ["Superficie", "Disegno della superficie", "Modifica della superficie"],
            brushSpSurface: ["Superficie", "Disegno della superficie", "Modifica della superficie"],
            brushLoSurface: ["Superficie", "Disegno della superficie", "Modifica della superficie"],
            brushLdVolumetricSurface: ["Superficie", "Disegno della superficie (m3)", "Modifica della superficie (m3)"],
            brushSpVolumetricSurface: ["Superficie", "Disegno della superficie (m3)", "Modifica della superficie (m3)"],
            brushLoVolumetricSurface: ["Superficie", "Disegno della superficie (m3)", "Modifica della superficie (m3)"],
            ...
            dl16: ["Ala gocciolante 16/13mm", "Disegno ala gocciolante 16/13mm", "Modifica linea gocciolante 16/13mm"],
            ds16: ["Gocciolamento inizio 16/13mm", "Disegno a goccia da 16/13mm", "Drip start editing 16/13mm"],
            ...
            pdcAdj: ["Ugello regolabile PRO-HE", "Posizionamento dell'ugello regolabile PRO-HE", "Modifica dell'ugello regolabile PRO-HE"],
            proHE: ["Ugello regolabile PRO", "Posizionamento dell'ugello regolabile PRO", "Modifica dell'ugello regolabile PRO"],
        ...
        vars: {
            ...
            obstacles: "Ostacoli per l'irrigazione",
            placementObstacles: "Ostacoli per il posizionamento",
            stdSurf: "Standard",
            ...
            wirelessControl: "Controllo wireless",
            sensorWire: "Filo del sensore",
            wirelessSensor: "Connessione wireless dei sensori",
            wirelessWire: "Connessione senza fili",
            dS16: "Gocciolamento inizio 16/13mm",
            ...
            "a0vert": "A0 Verticale",
            "dind4hor": "DIN D4 Orizzontale",
            "dind4vert": "DIN D4 Verticale",
            "dind3hor": "DIN D3 Orizzontale",
            "dind3vert": "DIN D3 Verticale",
            "dind2hor": "DIN D2 Orizzontale",
            "dind2vert": "DIN D2 Verticale",
            "dind1hor": "DIN D1 Orizzontale",
            "dind1vert": "DIN D1 Verticale",
            "dind0hor": "DIN D0 Orizzontale",
            "dind0vert": "DIN D0 Verticale",
            "ansiAhor": "ANSI A Orizzontale",
            "ansiAvert": "ANSI A Verticale",
            "ansiBhor": "ANSI B Orizzontale",
            "ansiBvert": "ANSI B Verticale",
            "ansiChor": "ANSI C Orizzontale",
            "ansiCvert": "ANSI C Verticale",
            "ansiDhor": "ANSI D Orizzontale",
            "ansiDvert": "ANSI D Verticale",
            "ansiEhor": "ANSI E Orizzontale",
            "ansiEvert": "ANSI E Verticale",
            "archAhor": "Arch A Orizzontale",
            "archAvert": "Arch A Verticale",
            "archBhor": "Arch B Orizzontale",
            "archBvert": "Arch B Verticale",
            "archChor": "Arch C Orizzontale",
            "archCvert": "Arch C Verticale",
            "archDhor": "Arch D Orizzontale",
            "archDvert": "Arch D Verticale",
            "archEhor": "Arch E Orizzontale",
            "archEvert": "Arch E Verticale",
            "archE1hor": "Arch E1 Orizzontale",
            "archE1vert": "Arch E1 Verticale",
            "archE2hor": "Arch E2 Orizzontale",
            "archE2vert": "Arch E2 Verticale",
            "archE3hor": "Arch E3 Orizzontale",
            stdCompass: "Bussola",
            gostSize: "Dimensioni",
