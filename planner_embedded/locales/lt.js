(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Linija", "Linija piešimas", "Linija redagavimas"],
            spLine: ["Linija", "Linija piešimas", "Linija redagavimas"],
            loLine: ["Linija", "Linija piešimas", "Linija redagavimas"],
            ldLineWithArea: ["Linija (m2)", "Linija (m2) piešimas", "Linija (m2) redagavimas"],
            spLineWithArea: ["Linija (m2)", "Linija (m2) piešimas", "Linija (m2) redagavimas"],
            loLineWithArea: ["Linija (m2)", "Linija (m2) piešimas", "Linija (m2) redagavimas"],
            ldVolumetricLine: ["Linija (m3)", "Linija (m3) piešimas", "Linija (m3) redagavimas"],
            spVolumetricLine: ["Linija (m3)", "Linija (m3) piešimas", "Linija (m3) redagavimas"],
            loVolumetricLine: ["Linija (m3)", "Linija (m3) piešimas", "Linija (m3) redagavimas"],
            polyLdSurface: ["Paviršius", "Paviršiaus brėžinys", "Paviršiaus redagavimas"],
            polySpSurface: ["Paviršius", "Paviršiaus brėžinys", "Paviršiaus redagavimas"],
            polyLoSurface: ["Paviršius", "Paviršiaus brėžinys", "Paviršiaus redagavimas"],
            polyLdVolumetricSurface: ["Paviršius", "Paviršiaus (m3) brėžinys", "Paviršiaus (m3) redagavimas"],
            polySpVolumetricSurface: ["Paviršius", "Paviršiaus (m3) brėžinys", "Paviršiaus (m3) redagavimas"],
            polyLoVolumetricSurface: ["Paviršius", "Paviršiaus (m3) brėžinys", "Paviršiaus (m3) redagavimas"],
            brushLdSurface: ["Paviršius", "Paviršiaus brėžinys", "Paviršiaus redagavimas"],
            brushSpSurface: ["Paviršius", "Paviršiaus brėžinys", "Paviršiaus redagavimas"],
            brushLoSurface: ["Paviršius", "Paviršiaus brėžinys", "Paviršiaus redagavimas"],
            brushLdVolumetricSurface: ["Paviršius", "Paviršiaus (m3) brėžinys", "Paviršiaus (m3) redagavimas"],
            brushSpVolumetricSurface: ["Paviršius", "Paviršiaus (m3) brėžinys", "Paviršiaus (m3) redagavimas"],
            brushLoVolumetricSurface: ["Paviršius", "Paviršiaus (m3) brėžinys", "Paviršiaus (m3) redagavimas"],
            ...
            dl16: ["Lašelinė linija 16/13mm", "Lašelinės linijos 16/13mm brėžinys", "Lašelinės linijos 16/13mm redagavimas"],
            ds16: ["Lašelinio pradžios 16/13mm", "Lašelinio pradžios 16/13mm brėžinys", "Lašelinio pradžios 16/13mm redagavimas"],
            ...
            "lpPVC": ["Lateralinis vamzdis", "Lateralinio vamzdžio brėžinys", "Lateralinio vamzdžio redagavimas"],
            "mp": ["Pagrindinis vamzdis", "Pagrindinio vamzdžio brėžinys", "Pagrindinio vamzdžio redagavimas"],
            "mpPVC": ["Pagrindinis vamzdis", "Pagrindinio vamzdžio brėžinys", "Pagrindinio vamzdžio redagavimas"],
        ...
        vars: {
            ...
            obstacles: "Kliūtys drėkinimui",
            placementObstacles: "Kliūtys įrengimui",
            ...
            wirelessControl: "Belaidis valdymas",
            sensorWire: "Jutiklių laidas",
            wirelessSensor: "Belaidis jutiklių ryšys",
            wirelessWire: "Bevielė ryšio linija",
            dS16: "Lašelinio laistymo pradžios jungtis 16/13mm",
            ...
            "dind4hor": "DIN D4 Horizontalus",
            "dind4vert": "DIN D4 Vertikalus",
            "dind3hor": "DIN D3 Horizontalus",
            "dind3vert": "DIN D3 Vertikalus",
            "dind2hor": "DIN D2 Horizontalus",
            "dind2vert": "DIN D2 Vertikalus",
            "dind1hor": "DIN D1 Horizontalus",
            "dind1vert": "DIN D1 Vertikalus",
            "dind0hor": "DIN D0 Horizontalus",
            "dind0vert": "DIN D0 Vertikalus",
            "ansiAhor": "ANSI A Horizontalus",
            "ansiAvert": "ANSI A Vertikalus",
            "ansiBhor": "ANSI B Horizontalus",
            "ansiBvert": "ANSI B Vertikalus",
            "ansiChor": "ANSI C Horizontalus",
            "ansiCvert": "ANSI C Vertikalus",
            "ansiDhor": "ANSI D Horizontalus",
            "ansiDvert": "ANSI D Vertikalus",
            "ansiEhor": "ANSI E Horizontalus",
            "ansiEvert": "ANSI E Vertikalus",
            "archAhor": "Arch A Horizontalus",
            "archAvert": "Arch A Vertikalus",
            "archBhor": "Arch B Horizontalus",
            "archBvert": "Arch B Vertikalus",
            "archChor": "Arch C Horizontalus",
            "archCvert": "Arch C Vertikalus",
            "archDhor": "Arch D Horizontalus",
            "archDvert": "Arch D Vertikalus",
            "archEhor": "Arch E Horizontalus",
            "archEvert": "Arch E Vertikalus",
            "archE1hor": "Arch E1 Horizontalus",
            "archE1vert": "Arch E1 Vertikalus",
            "archE2hor": "Arch E2 Horizontalus",
            "archE2vert": "Arch E2 Vertikalus",
            "archE3hor": "Arch E3 Horizontalus",
            stdCompass: "Kompasas",
            gostSize: "Dydis",
