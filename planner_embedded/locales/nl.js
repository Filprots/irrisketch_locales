(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Lijn", "Lijn tekenen", "Lijn bewerking"],
            spLine: ["Lijn", "Lijn tekenen", "Lijn bewerking"],
            loLine: ["Lijn", "Lijn tekenen", "Lijn bewerking"],
            ldLineWithArea: ["Lijn (m2)", "Lijn (m2) tekenen", "Lijn (m2) bewerking"],
            spLineWithArea: ["Lijn (m2)", "Lijn (m2) tekenen", "Lijn (m2) bewerking"],
            loLineWithArea: ["Lijn (m2)", "Lijn (m2) tekenen", "Lijn (m2) bewerking"],
            ldVolumetricLine: ["Lijn (m3)", "Lijn (m3) tekenen", "Lijn (m3) bewerking"],
            spVolumetricLine: ["Lijn (m3)", "Lijn (m3) tekenen", "Lijn (m3) bewerking"],
            loVolumetricLine: ["Lijn (m3)", "Lijn (m3) tekenen", "Lijn (m3) bewerking"],
            polyLdSurface: ["Oppervlak", "Oppervlak tekenen", "Oppervlak bewerken"],
            polySpSurface: ["Oppervlak", "Oppervlak tekenen", "Oppervlak bewerken"],
            polyLoSurface: ["Oppervlak", "Oppervlak tekenen", "Oppervlak bewerken"],
            polyLdVolumetricSurface: ["Oppervlak", "Oppervlak (m3) tekenen", "Oppervlak (m3) bewerken"],
            polySpVolumetricSurface: ["Oppervlak", "Oppervlak (m3) tekenen", "Oppervlak (m3) bewerken"],
            polyLoVolumetricSurface: ["Oppervlak", "Oppervlak (m3) tekenen", "Oppervlak (m3) bewerken"],
            brushLdSurface: ["Oppervlak", "Oppervlak tekenen", "Oppervlak bewerken"],
            brushSpSurface: ["Oppervlak", "Oppervlak tekenen", "Oppervlak bewerken"],
            brushLoSurface: ["Oppervlak", "Oppervlak tekenen", "Oppervlak bewerken"],
            brushLdVolumetricSurface: ["Oppervlak", "Oppervlak (m3) tekenen", "Oppervlak (m3) bewerken"],
            brushSpVolumetricSurface: ["Oppervlak", "Oppervlak (m3) tekenen", "Oppervlak (m3) bewerken"],
            brushLoVolumetricSurface: ["Oppervlak", "Oppervlak (m3) tekenen", "Oppervlak (m3) bewerken"],
