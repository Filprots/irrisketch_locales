 (function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Linia", "Linia rysowanie", "Linia edycja"],
            spLine: ["Linia", "Linia rysowanie", "Linia edycja"],
            loLine: ["Linia", "Linia rysowanie", "Linia edycja"],
            ldLineWithArea: ["Linia (m2)", "Linia (m2) rysowanie", "Linia (m2) edycja"],
            spLineWithArea: ["Linia (m2)", "Linia (m2) rysowanie", "Linia (m2) edycja"],
            loLineWithArea: ["Linia (m2)", "Linia (m2) rysowanie", "Linia (m2) edycja"],
            ldVolumetricLine: ["Linia (m3)", "Linia (m3) rysowanie", "Linia (m3) edycja"],
            spVolumetricLine: ["Linia (m3)", "Linia (m3) rysowanie", "Linia (m3) edycja"],
            loVolumetricLine: ["Linia (m3)", "Linia (m3) rysowanie", "Linia (m3) edycja"],
            polyLdSurface: ["Powierzchnia", "Rysowanie powierzchni", "Edycja powierzchni"],
            polySpSurface: ["Powierzchnia", "Rysowanie powierzchni", "Edycja powierzchni"],
            polyLoSurface: ["Powierzchnia", "Rysowanie powierzchni", "Edycja powierzchni"],
            polyLdVolumetricSurface: ["Powierzchnia", "Rysowanie powierzchni (m3)", "Edycja powierzchni (m3)"],
            polySpVolumetricSurface: ["Powierzchnia", "Rysowanie powierzchni (m3)", "Edycja powierzchni (m3)"],
            polyLoVolumetricSurface: ["Powierzchnia", "Rysowanie powierzchni (m3)", "Edycja powierzchni (m3)"],
            brushLdSurface: ["Powierzchnia", "Rysowanie powierzchni", "Edycja powierzchni"],
            brushSpSurface: ["Powierzchnia", "Rysowanie powierzchni", "Edycja powierzchni"],
            brushLoSurface: ["Powierzchnia", "Rysowanie powierzchni", "Edycja powierzchni"],
            brushLdVolumetricSurface: ["Powierzchnia", "Rysowanie powierzchni (m3)", "Edycja powierzchni (m3)"],
            brushSpVolumetricSurface: ["Powierzchnia", "Rysowanie powierzchni (m3)", "Edycja powierzchni (m3)"],
            brushLoVolumetricSurface: ["Powierzchnia", "Rysowanie powierzchni (m3)", "Edycja powierzchni (m3)"],
