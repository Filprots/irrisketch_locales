(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Linha", "Linha desenho", "Linha edição"],
            spLine: ["Linha", "Linha desenho", "Linha edição"],
            loLine: ["Linha", "Linha desenho", "Linha edição"],
            ldLineWithArea: ["Linha (m2)", "Linha (m2) desenho", "Linha (m2) edição"],
            spLineWithArea: ["Linha (m2)", "Linha (m2) desenho", "Linha (m2) edição"],
            loLineWithArea: ["Linha (m2)", "Linha (m2) desenho", "Linha (m2) edição"],
            ldVolumetricLine: ["Linha (m3)", "Linha (m3) desenho", "Linha (m3) edição"],
            spVolumetricLine: ["Linha (m3)", "Linha (m3) desenho", "Linha (m3) edição"],
            loVolumetricLine: ["Linha (m3)", "Linha (m3) desenho", "Linha (m3) edição"],
            polyLdSurface: ["Superfície", "Desenho de superfície", "Edição de superfície"],
            polySpSurface: ["Superfície", "Desenho de superfície", "Edição de superfície"],
            polyLoSurface: ["Superfície", "Desenho de superfície", "Edição de superfície"],
            polyLdVolumetricSurface: ["Superfície", "Desenho de superfície (m3)", "Edição de superfície (m3)"],
            polySpVolumetricSurface: ["Superfície", "Desenho de superfície (m3)", "Edição de superfície (m3)"],
            polyLoVolumetricSurface: ["Superfície", "Desenho de superfície (m3)", "Edição de superfície (m3)"],
            brushLdSurface: ["Superfície", "Desenho de superfície", "Edição de superfície"],
            brushSpSurface: ["Superfície", "Desenho de superfície", "Edição de superfície"],
            brushLoSurface: ["Superfície", "Desenho de superfície", "Edição de superfície"],
            brushLdVolumetricSurface: ["Superfície", "Desenho de superfície (m3)", "Edição de superfície (m3)"],
            brushSpVolumetricSurface: ["Superfície", "Desenho de superfície (m3)", "Edição de superfície (m3)"],
            brushLoVolumetricSurface: ["Superfície", "Desenho de superfície (m3)", "Edição de superfície (m3)"],
            ...
            dl16: ["Drip line 16/13mm", "Drip line 16/13mm drawing", "Drip line 16/13mm editing"],
            ds16: ["Drip start 16/13mm", "Drip start 16/13mm drawing", "Drip start 16/13mm editing"],
            ...
            "lpPVC": ["Lateral pipe", "Lateral pipe drawing", "Lateral pipe editing"],
            "mp": ["Main pipe", "Main pipe drawing", "Main pipe editing"],
            "mpPVC": ["Main pipe", "Main pipe drawing", "Main pipe editing"],
        ...
        vars: {
            ...
            obstacles: "Obstáculos para a irrigação",
            placementObstacles: "Obstáculos para o posicionamento",
            stdSurf: "Standard",
            ...
            wirelessControl: "Controle sem fio",
            sensorWire: "Sensor wire",
            wirelessSensor: "Conexão sem fio de sensores",
