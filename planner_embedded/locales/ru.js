(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            brushIrrigateMarks: ["Специальный маркер", "Рисование специального маркера", "Редактирование специального маркера"],
            ...
            ldLine: ["Линия", "Линия рисование", "Линия редактирование"],
            spLine: ["Линия", "Линия рисование", "Линия редактирование"],
            loLine: ["Линия", "Линия рисование", "Линия редактирование"],
            ldLineWithArea: ["Линия (m2)", "Линия (m2) рисование", "Линия (m2) редактирование"],
            spLineWithArea: ["Линия (m2)", "Линия (m2) рисование", "Линия (m2) редактирование"],
            loLineWithArea: ["Линия (m2)", "Линия (m2) рисование", "Линия (m2) редактирование"],
            ldVolumetricLine: ["Линия (m3)", "Линия (m3) рисование", "Линия (m3) редактирование"],
            spVolumetricLine: ["Линия (m3)", "Линия (m3) рисование", "Линия (m3) редактирование"],
            loVolumetricLine: ["Линия (m3)", "Линия (m3) рисование", "Линия (m3) редактирование"],
            polyLdSurface: ["Поверхность", "Рисование поверхности", "Редактирование поверхности"],
            polySpSurface: ["Поверхность", "Рисование поверхности", "Редактирование поверхности"],
            polyLoSurface: ["Поверхность", "Рисование поверхности", "Редактирование поверхности"],
            polyLdVolumetricSurface: ["Поверхность", "Рисование поверхности (m3)", "Редактирование поверхности (m3)"],
            polySpVolumetricSurface: ["Поверхность", "Рисование поверхности (m3)", "Редактирование поверхности (m3)"],
            polyLoVolumetricSurface: ["Поверхность", "Рисование поверхности (m3)", "Редактирование поверхности (m3)"],
            brushLdSurface: ["Поверхность", "Рисование поверхности", "Редактирование поверхности"],
            brushSpSurface: ["Поверхность", "Рисование поверхности", "Редактирование поверхности"],
            brushLoSurface: ["Поверхность", "Рисование поверхности", "Редактирование поверхности"],
            brushLdVolumetricSurface: ["Поверхность", "Рисование поверхности (m3)", "Редактирование поверхности (m3)"],
            brushSpVolumetricSurface: ["Поверхность", "Рисование поверхности (m3)", "Редактирование поверхности (m3)"],
            brushLoVolumetricSurface: ["Поверхность", "Рисование поверхности (m3)", "Редактирование поверхности (m3)"],
            ...
            polyIrrigateMarks: ["Специальный маркер", "Рисование специального маркера", "Редактирование специального маркера"],
            ...
            dl16: ["Капельная линия 16/13mm", "Укладка капельной линии 16/13mm", "Редактирование капельной линии 16/13mm"],
            ds16: ["Старт 16/13mm", "Рисование капельного старта 16/13mm", "Редактирование капельного старта 16/13mm"],
            ...
            proHE: ["PRO-HE Adjustable Nozzle", "Установка форсунки PRO-HE Adjustable", "Редактирование форсунки PRO-HE Adjustable"],
            prosFixed: ["PRO Fixed Nozzle", "Установка форсунки PRO Fixed", "Редактирование форсунки PRO Fixed"],
        ...
        vars: {
            ...
            obstacles: "Препятствия для ирригации",
            placementObstacles: "Препятствия для размещения",
            stdSurf: "Стандартная",
            ...
            wirelessControl: "Беспроводное управление",
            sensorWire: "Проводка датчика",
            wirelessSensor: "Беспроводное соединение датчиков",
            ...
            "dind4hor": "DIN D4 Горизонтальный",
            "dind4vert": "DIN D4 Вертикальный",
            "dind3hor": "DIN D3 Горизонтальный",
            "dind3vert": "DIN D3 Вертикальный",
            "dind2hor": "DIN D2 Горизонтальный",
            "dind2vert": "DIN D2 Вертикальный",
            "dind1hor": "DIN D1 Горизонтальный",
            "dind1vert": "DIN D1 Вертикальный",
            "dind0hor": "DIN D0 Горизонтальный",
            "dind0vert": "DIN D0 Вертикальный",
            "ansiAhor": "ANSI A Горизонтальный",
            "ansiAvert": "ANSI A Вертикальный",
            "ansiBhor": "ANSI B Горизонтальный",
            "ansiBvert": "ANSI B Вертикальный",
            "ansiChor": "ANSI C Горизонтальный",
            "ansiCvert": "ANSI C Вертикальный",
            "ansiDhor": "ANSI D Горизонтальный",
            "ansiDvert": "ANSI D Вертикальный",
            "ansiEhor": "ANSI E Горизонтальный",
            "ansiEvert": "ANSI E Вертикальный",
            "archAhor": "Arch A Горизонтальный",
            "archAvert": "Arch A Вертикальный",
            "archBhor": "Arch B Горизонтальный",
            "archBvert": "Arch B Вертикальный",
            "archChor": "Arch C Горизонтальный",
            "archCvert": "Arch C Вертикальный",
            "archDhor": "Arch D Горизонтальный",
            "archDvert": "Arch D Вертикальный",
            "archEhor": "Arch E Горизонтальный",
            "archEvert": "Arch E Вертикальный",
            "archE1hor": "Arch E1 Горизонтальный",
            "archE1vert": "Arch E1 Вертикальный",
            "archE2hor": "Arch E2 Горизонтальный",
            "archE2vert": "Arch E2 Вертикальный",
            "archE3hor": "Arch E3 Горизонтальный",
            stdCompass: "Компасс",
            gostSize: "Размерная линия",
