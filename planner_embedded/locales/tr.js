(function (p) {
    if (window.paperLocale !== "tr") return false;
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Çizgi", "Çizgi çizim", "Çizgi düzenleme"],
            spLine: ["Çizgi", "Çizgi çizim", "Çizgi düzenleme"],
            loLine: ["Çizgi", "Çizgi çizim", "Çizgi düzenleme"],
            ldLineWithArea: ["Çizgi (m2)", "Çizgi (m2) çizim", "Çizgi (m2) düzenleme"],
            spLineWithArea: ["Çizgi (m2)", "Çizgi (m2) çizim", "Çizgi (m2) düzenleme"],
            loLineWithArea: ["Çizgi (m2)", "Çizgi (m2) çizim", "Çizgi (m2) düzenleme"],
            ldVolumetricLine: ["Çizgi (m3)", "Çizgi (m3) çizim", "Çizgi (m3) düzenleme"],
            spVolumetricLine: ["Çizgi (m3)", "Çizgi (m3) çizim", "Çizgi (m3) düzenleme"],
            loVolumetricLine: ["Çizgi (m3)", "Çizgi (m3) çizim", "Çizgi (m3) düzenleme"],
            polyLdSurface: ["Yüzey", "Yüzey çizimi", "Yüzey düzenleme"],
            polySpSurface: ["Yüzey", "Yüzey çizimi", "Yüzey düzenleme"],
            polyLoSurface: ["Yüzey", "Yüzey çizimi", "Yüzey düzenleme"],
            polyLdVolumetricSurface: ["Yüzey", "Yüzey (m3) çizimi", "Yüzey (m3) düzenleme"],
            polySpVolumetricSurface: ["Yüzey", "Yüzey (m3) çizimi", "Yüzey (m3) düzenleme"],
            polyLoVolumetricSurface: ["Yüzey", "Yüzey (m3) çizimi", "Yüzey (m3) düzenleme"],
            brushLdSurface: ["Yüzey", "Yüzey çizimi", "Yüzey düzenleme"],
            brushSpSurface: ["Yüzey", "Yüzey çizimi", "Yüzey düzenleme"],
            brushLoSurface: ["Yüzey", "Yüzey çizimi", "Yüzey düzenleme"],
            brushLdVolumetricSurface: ["Yüzey", "Yüzey (m3) çizimi", "Yüzey (m3) düzenleme"],
            brushSpVolumetricSurface: ["Yüzey", "Yüzey (m3) çizimi", "Yüzey (m3) düzenleme"],
            brushLoVolumetricSurface: ["Yüzey", "Yüzey (m3) çizimi", "Yüzey (m3) düzenleme"],
            ...
            dl16: ["Damlama hattı 16/13mm", "Damlama hattı 16/13mm çizimi", "Damlama hattı 16/13mm düzenleme"],
            ds16: ["Damlama başlangıcı 16/13mm", "Damlama başlangıcı 16/13mm çizimi", "Damlama başlangıcı 16/13mm düzenleme"],
            ...
            proHE: ["PRO-HE Ayarlanabilir Nozul", "PRO-HE Ayarlanabilir Nozul yerleştirme", "PRO-HE Ayarlanabilir Nozul düzenleme"],
        ...
        vars: {
            ...
            obstacles: "Sulama için engeller",
            placementObstacles: "Yerleştirme engelleri",
            "stdSurf": "Standart",
            "fineCut": "İnce çim",
            "raw": "Ham beton",
            "soft": "Yumuşak kum",
            ...
            wirelessControl: "Kablosuz kontrol",
            "sensorWire": "Sensör kablosu",
            "wirelessWire": "Kablosuz bağlantı",
            wirelessSensor: "Kablosuz sensör bağlantısı",
            "dS16": "Damlalık başlangıcı 16/13mm",
