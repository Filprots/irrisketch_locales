(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            ldLine: ["Лінія", "Лінія малювання", "Лінія редагування"],
            spLine: ["Лінія", "Лінія малювання", "Лінія редагування"],
            loLine: ["Лінія", "Лінія малювання", "Лінія редагування"],
            ldLineWithArea: ["Лінія (m2)", "Лінія (m2) малювання", "Лінія (m2) редагування"],
            spLineWithArea: ["Лінія (m2)", "Лінія (m2) малювання", "Лінія (m2) редагування"],
            loLineWithArea: ["Лінія (m2)", "Лінія (m2) малювання", "Лінія (m2) редагування"],
            ldVolumetricLine: ["Лінія (m3)", "Лінія (m3) малювання", "Лінія (m3) редагування"],
            spVolumetricLine: ["Лінія (m3)", "Лінія (m3) малювання", "Лінія (m3) редагування"],
            loVolumetricLine: ["Лінія (m3)", "Лінія (m3) малювання", "Лінія (m3) редагування"],
            polyLdSurface: ["Поверхня", "Малювання поверхні", "Редагування поверхні"],
            polySpSurface: ["Поверхня", "Малювання поверхні", "Редагування поверхні"],
            polyLoSurface: ["Поверхня", "Малювання поверхні", "Редагування поверхні"],
            polyLdVolumetricSurface: ["Поверхня", "Малювання поверхні (m3)", "Редагування поверхні (m3)"],
            polySpVolumetricSurface: ["Поверхня", "Малювання поверхні (m3)", "Редагування поверхні (m3)"],
            polyLoVolumetricSurface: ["Поверхня", "Малювання поверхні (m3)", "Редагування поверхні (m3)"],
            brushLdSurface: ["Поверхня", "Малювання поверхні", "Редагування поверхні"],
            brushSpSurface: ["Поверхня", "Малювання поверхні", "Редагування поверхні"],
            brushLoSurface: ["Поверхня", "Малювання поверхні", "Редагування поверхні"],
            brushLdVolumetricSurface: ["Поверхня", "Малювання поверхні (m3)", "Редагування поверхні (m3)"],
            brushSpVolumetricSurface: ["Поверхня", "Малювання поверхні (m3)", "Редагування поверхні (m3)"],
            brushLoVolumetricSurface: ["Поверхня", "Малювання поверхні (m3)", "Редагування поверхні (m3)"],
            ...
            dl16: ["Крапельна лінія 16/13mm", "Прокладання крапельної лінії 16/13mm", "Редагування крапельної лінії 16/13mm"],
            ds16: ["Старт 16/13mm", "Малювання крапельного старту 16/13mm", "Редагування крапельного старту 16/13mm"],
            ...
            proHE: ["PRO-HE Adjustable Nozzle", "Монутвання форсунки PRO-HE Adjustable", "Редагування форсунки PRO-HE Adjustable"],
            ...
            "lpPVC": ["Зональна труба", "Малювання зональної труби", "Редагування зональної труби"],
            "mp": ["Основна магістраль", "Малювання основної магістралі", "Редагування основної магістралі"],
            "mpPVC": ["Основна магістраль", "Малювання основної магістралі", "Редагування основної магістралі"],
        ...
        vars: {
            ...
            obstacles: "Перешкоди для іригації",
            placementObstacles: "Перешкоди для розміщення",
            stdSurf: "Стандартна",
            ...
            wirelessControl: "Бездротове керування",
            sensorWire: "Провід датчика",
            wirelessWire: "Беспроводное подключение",
            wirelessSensor: "Бездротове з'єднання сенсорів",
            dS16: "Старт 16/13mm",
            dS17: "Старт 17мм",
