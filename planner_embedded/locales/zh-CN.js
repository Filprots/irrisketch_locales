(function (p) {
    ...
    p.ELNG = {
        types: {
            ...
            spLine: ["线", "线 绘制", "线 编辑"],
            loLine: ["线", "线 绘制", "线 编辑"],
            ldLineWithArea: ["线 (m2)", "线 (m2) 绘制", "线 (m2) 编辑"],
            spLineWithArea: ["线 (m2)", "线 (m2) 绘制", "线 (m2) 编辑"],
            loLineWithArea: ["线 (m2)", "线 (m2) 绘制", "线 (m2) 编辑"],
            ldVolumetricLine: ["线 (m3)", "线 (m3) 绘制", "线 (m3) 编辑"],
            spVolumetricLine: ["线 (m3)", "线 (m3) 绘制", "线 (m3) 编辑"],
            loVolumetricLine: ["线 (m3)", "线 (m3) 绘制", "线 (m3) 编辑"],
            polyLdSurface: ["表面", "表面绘制", "表面编辑"],
            polySpSurface: ["表面", "表面绘制", "表面编辑"],
            polyLoSurface: ["表面", "表面绘制", "表面编辑"],
            polyLdVolumetricSurface: ["表面", "表面 (m3) 绘制", "表面 (m3) 编辑"],
            polySpVolumetricSurface: ["表面", "表面 (m3) 绘制", "表面 (m3) 编辑"],
            polyLoVolumetricSurface: ["表面", "表面 (m3) 绘制", "表面 (m3) 编辑"],
            brushLdSurface: ["表面", "表面绘制", "表面编辑"],
            brushSpSurface: ["表面", "表面绘制", "表面编辑"],
            brushLoSurface: ["表面", "表面绘制", "表面编辑"],
            brushLdVolumetricSurface: ["表面", "表面 (m3) 绘制", "表面 (m3) 编辑"],
            brushSpVolumetricSurface: ["表面", "表面 (m3) 绘制", "表面 (m3) 编辑"],
            brushLoVolumetricSurface: ["表面", "表面 (m3) 绘制", "表面 (m3) 编辑"],
            bush: ["灌木", "种植灌木", "编辑灌木"],
